...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "**💭 Hey. Ciao!**\n\n⚠️ ASH non dà a nessuno il permesso di scrivergli per motivi che non devi sapere.**\n\n**ℹ️ Se continuerai a mandare messaggi, al quarto che invierai, sarai bloccato!**\n\n**Adios! 🌪**"
# =================================================================
        ...
        if event.is_private and not (await event.get_sender()).bot:
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 4:
                    await event.respond("**💭 Ops!**\n\n⚠️ **Hai mandato più di 4 messaggi!**\n\n⛔️ Sarò costretto a bloccarti. See ya!**")
                    ...
                    if BOTLOG:
                        ...
                        await event.client.send_message(
                            ...
                            "[" + name0 + "](tg://user?id=" +
                            str(event.chat_id) + ")" +
                            " era solo un altro ritardato mentale",
                        )
...
async def notifon(non_event):
    ...
    if not non_event.text[0].isalpha() and non_event.text[0] not in ("/", "#",
        ...
        if await notif_on() is False:
            ...
            return await non_event.edit("**Notifiche silenziate!**")
...
async def approvepm(apprvpm):
    ...
    if not apprvpm.text[0].isalpha() and apprvpm.text[0] not in ("/", "#", "@",
        ...
        if await approve(apprvpm.chat_id) is False:
            return await apprvpm.edit("**💭 Utente autorizzato a scrivermi in privato!**")
        else:
            ...
            await apprvpm.edit(
                f"[{name0}](tg://user?id={uid}) `**💭 Utente autorizzato a scrivermi in privato!**")
