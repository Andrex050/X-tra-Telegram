...
async def _(event):
    ...
    replied_user_profile_photos_count = "Nope"
    try:
    ...
    try:
        ...
        dc_id = "<code>Serve una foto profilo per verificare questo.</code>"
        location = str(e)
...
<b>  • 🔑 Limitato:</b> <code>{}</code>
<b>  • ✅ Verificato:</b> <code>{}</code>
<b>  • 🤖 Bot:</b> <code>{}</code>
<b>  • 💡 Gruppi in comune:</b> <code>{}</code>
""".format(
        user_id,
        user_id,
        first_name,
