...
async def download_video(v_url):
    ...
    try:
        ...
        await v_url.edit("**Il video è troppo corto!**")
        return
        ...
        await v_url.edit("**Hai superato il numero di download!**")
        return
    except PostProcessingError:
        await v_url.edit("**C'è stato un errore durante il processo!**")
        return
    except UnavailableVideoError:
        await v_url.edit("**Il media non è disponibile nel formato richiesto!**")
        return
    except XAttrMetadataError as XAME:
        await v_url.edit(f"`{XAME.code}: {XAME.msg}\n{XAME.reason}`")
        return
    except ExtractorError:
        await v_url.edit("**Si è verificato un errore durante l'estrazione del file!**")
        return
